	...
	var CONFIG = (function ($, window) {
		...
		return {
			...
			objContactForm: {
				...
				emailAddress: 'info@fermes.quebec'   // Email for contact
			},
			...
			objSequence : {
				...
				pauseOnHover: true,// Boolean:  (true/false). Whether frames should stop auto playing when the user hovers over Sequence. autoPlay will continue again when the 
