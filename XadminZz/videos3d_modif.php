...
if ((isset($_SESSION['username_imex'])) && (!empty($_SESSION['username_imex']))){
		...
		if ($sAction == "U") {
			...
			$x_script = $_POST["script"];
				...
				if($x_vignette){
					$maj = "UPDATE videos_3d SET script = '".$x_script."', classement = '".$x_classement."', vignette = '".$x_vignette."',description = '".$x_description."' WHERE id = '".$id."'";										
					include("charg_fic_vignette.php");
				 } else {
					$maj = "UPDATE videos_3d SET script = '".$x_script."', classement = '".$x_classement."', ";										
			...
			header("Location: videos3d_liste.php");
			exit;
		}
		?>
		...
		<body>
		<?php
		 $requete = "SELECT * FROM videos_3d WHERE id = '".$id."'";
		 $resultats = mysql_query($requete);
		 $data = mysql_fetch_array($resultats) ;
		
		?>
		
		<form action="videos3d_modif.php?id=<?php echo $id;?>" method="POST" enctype="multipart/form-data">
		...
		<table width="800" cellpadding="0" cellspacing="0" align="center">
			...
			<td class="entete" height="151" valign="bottom">
			  ...
			  <div style="line-height:30px"><span class="stats">&nbsp;&nbsp;Modifier une vidéo</span></div>
			...
			<table width="800" cellpadding="5" cellspacing="0">
                ...
                <textarea name="description" rows="5" cols="70" value=""><?php echo stripslashes($data["description"]);?> </textarea>
                </td>
                </tr>
                <tr>
                <td class="corps">Lien vidéo&nbsp;&nbsp;<br />
                <textarea name="script" rows="8" cols="70" value=""><?php echo $data["script"];?> </textarea>
                </td>
                </tr>
                <tr>
				<td class="corps">
				...
				<tr>
				<td class="corps">
				<input name="form_stats" type="submit" value="Mettre à jour" />&nbsp;&nbsp;<input type="button" value="Annuler / Retour à la liste" onclick="location.href='videos3d_liste.php'" />
                </td>
                </tr>
			</table>
