...
if ((isset($_SESSION['username_imex'])) && (!empty($_SESSION['username_imex']))){
		...
		<table width="800" cellpadding="0" cellspacing="0" align="center">
			...
			<td class="entete" height="151" valign="bottom">
			  ...
			  <div style="line-height:30px"><span class="stats">&nbsp;&nbsp;Supprimer une video</span></div>
		  
			<hr width="790"></td>
			</tr>
			<tr>
			<td class="corps">
			<form action="videos_supp.php?id=<?php echo $id;?>" method="POST">
			...
			<tr>
			<td colspan="3"><br />
			<input name="form_stats" type="submit" value="supprimer" />&nbsp;&nbsp; <input name="form_stats" type="button" value="Annuler / Retour à la liste" onclick="location.href='videos_liste.php'" /></td>
			</tr>
		</table>
