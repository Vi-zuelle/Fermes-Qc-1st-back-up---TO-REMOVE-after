-- ----------------------
-- dump de la base  au 13-Sep-2018
-- ----------------------
...
-- -----------------------------
-- creation de la table photos_accueil
-- -----------------------------
CREATE TABLE `photos_accueil` (
  `id` int(2) NOT NULL AUTO_INCREMENT,
  `titre` varchar(80) NOT NULL,
  `lien` varchar(80) NOT NULL,
  `text_lien` varchar(80) NOT NULL,
  `nom_photo` varchar(80) NOT NULL,
  `code` int(2) NOT NULL,
  PRIMARY KEY (`id`)
...
-- -----------------------------
INSERT INTO administrateurs VALUES(1, 'alain', '3334alain', 1);
...
INSERT INTO fermes VALUES(27, 'FERME MORGAN', '92 Chemin Morgan, Weir J0T 2V0', 'Elevage et ferme biologique intégrant la permaculture.
', 'http://www.fermemorgan.com/fr/', '6848-019.JPG', 1, '6848-013.JPG', 1, '6848-020.JPG', 1, '6848-016.JPG', 1, '', 0, '', '', '', 0, '', 0);
...
-- -----------------------------
-- insertions dans la table photos_accueil
-- -----------------------------
INSERT INTO photos_accueil VALUES(1, '<span>PHOTOS ET VIDÉOS AÉRIENNES</span>', '', '', 'fermes_accueil1.jpg', 1);
INSERT INTO photos_accueil VALUES(2, '<span>VOTRE EXPLOITATION</span> <br />VUE DU CIEL', 'galerie.php', 'Visitez notre galerie', 'Accueil-Fermes-Quebec-photos-aeriennes.jpg', 2);
INSERT INTO photos_accueil VALUES(3, '<span>TROIS PRODUITS</span> <br />FAITES VOTRE CHOIX', 'services.php', 'Nos forfaits', 'fermes_accueil4.jpg', 3);
...
INSERT INTO stat_domai VALUES(1, 2017-05-01, 'xx', 'com', 1);
INSERT INTO stat_domai VALUES(1, 2017-07-01, 'xx', 'com', 1);
INSERT INTO stat_domai VALUES(1, 2017-07-22, 'xx', 'com', 1);
...
INSERT INTO stat_heure VALUES(1, 2017-05-01, 15, 1, 1);
INSERT INTO stat_heure VALUES(1, 2017-07-01, 5, 1, 1);
INSERT INTO stat_heure VALUES(1, 2017-07-22, 17, 1, 1);
...
INSERT INTO stat_pages VALUES(1, 2017-05-01, '/stats.php', 1);
INSERT INTO stat_pages VALUES(1, 2017-07-01, '/stats.php', 1);
INSERT INTO stat_pages VALUES(1, 2017-07-22, '/stats.php', 1);

-- -----------------------------
-- insertions dans la table stat_recent
-- -----------------------------
INSERT INTO stat_recent VALUES(1, 2017-05-01 15:08:56.000000, '51.15.42.114', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36');
INSERT INTO stat_recent VALUES(1, 2017-07-22 17:05:53.000000, '51.15.54.85', 'Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; rv:11.0) like Gecko');
INSERT INTO stat_recent VALUES(1, 2017-07-01 05:21:46.000000, '51.15.46.11', 'Opera/9.80 (X11; Linux i686; Ubuntu/14.10) Presto/2.12.388 Version/12.16');
...
INSERT INTO stat_refer VALUES(1, 2017-05-01, 'lien direct', 1);
INSERT INTO stat_refer VALUES(1, 2017-07-01, 'lien direct', 1);
INSERT INTO stat_refer VALUES(1, 2017-07-22, 'lien direct', 1);
...
INSERT INTO stat_visit VALUES(1, 2017-05-01, 'winNT', 'SA', '537', 1, 1);
INSERT INTO stat_visit VALUES(1, 2017-07-01, 'linux', 'OP', '9.80', 1, 1);
INSERT INTO stat_visit VALUES(1, 2017-07-22, 'winXP', 'MZ', '11.0', 1, 1);
