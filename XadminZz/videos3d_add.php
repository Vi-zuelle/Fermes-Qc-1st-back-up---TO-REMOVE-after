...
if ((isset($_SESSION['username_imex'])) && (!empty($_SESSION['username_imex']))){
		...
		if ($sAction == "U") {
			...
			mysql_query("INSERT INTO videos_3d(vignette,description,classement,script) VALUES('".$x_photo."','".$x_description."','".$x_classement."','".$x_script."')");
		...
		<table width="800" cellpadding="0" cellspacing="0" align="center">
			...
			<td class="entete" height="151" valign="bottom"><br /><br /><br /><br />
			  ...
			  <div align="center"><span class="stats">&nbsp;&nbsp;Ajouter une Vidéo 3D</span></div>
		  
			<hr width="790"></td>
			</tr>
			<tr><td>
			  <form action="videos3d_add.php" method="POST" enctype="multipart/form-data">
			...
			<table width="800" cellpadding="5" cellspacing="0">
				...
				<td class="corps">
                Fichier vignette<br />
                <input name="photo" type="file" size="70" maxlength="80" value="">
				...
				<tr>
				<td class="corps"><br />
				<input name="form_stats" type="submit" value="Ajouter" />&nbsp;&nbsp;<input type="button" value="Annuler / Retour à la liste" onclick="location.href='videos3d_liste.php'" /></td>
			</table>
