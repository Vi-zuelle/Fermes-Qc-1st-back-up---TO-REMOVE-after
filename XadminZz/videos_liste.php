...
?>
		...
		<body>
		<?php
		 $requete = "SELECT * FROM videos ORDER BY classement ASC";
		...
		<table width="800" cellpadding="0" cellspacing="0" align="center">
			...
			<div style="line-height:30px"><span class="stats">&nbsp;&nbsp;Les Videos</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="videos_add.php">Ajouter une video (CLIQUER ICI)</a></div>
		<hr width="790"></td>
			</tr>
			<?php
						...
						<td class="corps">
						  ...
						  <table width="790" cellspacing="0" cellpadding="5">
						   <tr bgcolor="<?php echo $couleur1 ;?>" height="40">
							...
							<td width="76" align="center" valign="top"><a href="videos_modif.php?id=<?php echo $data["id"]; ?>">MODIFIER<img src="images/Modify.png" width="30" height="30" alt="Modifier" border="0" /></a></td>
							<td width="71" align="center" valign="top"><a href="videos_supp.php?id=<?php echo $data["id"]; ?>">SUPPRIMER<img src="images/Delete.png" width="27" height="27" alt="Supprimer" border="0" /></a></td>
						  </tr>
						 </table>
